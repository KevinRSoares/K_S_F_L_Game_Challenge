			...
			if ($stmt->error) {
				...
				if ($result->num_rows > 0) {
					if($row = $result->fetch_assoc()) {
						...
						$Recuperacao = '<div style=" background-color: #d395f4; padding: 5px ;  font-size: 15px;
						border-radius: 5px;"  class="card">
							<div class="card-body">
							<p >  Nome: '.$Nome.'<br>  E-mail: '.$Email.'<br>  Senha: '.$Senha.' <br>  Venha jogar novamente:  http://35.196.97.121/FastMind/index.php?page=Login </p>
