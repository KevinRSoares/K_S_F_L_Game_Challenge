<div class="text-center formEsqueci">
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            Enviamos a nova senha para seu Email! Favor verificar.
        </div>
        <a  href="index.php?page=Login" class="btn btn-secondary" alt="Botão para voltar ao login" title="Clique aqui para voltar a página de login">Login </a>
        </div>
    </div>
  </div>
</div>